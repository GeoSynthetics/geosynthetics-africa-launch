  ...
  return sections.map((section) => {
    ...
    return {
      ...
      columns: {
          ...
          return {
            ...
            content: item.megaFallback
              ? {
                  ...
                  secondary:
                    item.megaFallback.secondary && item.megaFallback.secondary.length > 0
                  ...
                  quickActions:
                    item.megaFallback.quickActions && item.megaFallback.quickActions.length > 0
              ...
              : {
                  ...
                  quickActions:
                    item.quickActions && item.quickActions.length > 0 ? item.quickActions : [],
        ...
        secondary:
          fallback.secondary ??
          firstItem?.children?.map((c) => ({ label: c.label, to: c.to, params: c.params })) ??
          [],
...
export function getDefaultSections(): HierarchySection[] {
  return [
    ...
    },
    {
      ...
      items: [
        mkSimpleItem("mining-systems", "Mining Systems", "Pickaxe", "/$slug", {
          slug: "mining-systems",
        }),
        mkSimpleItem("water-containment", "Water Containment", "Droplets", "/$slug", {
          slug: "water-containment",
        }),
        mkSimpleItem("waste-landfills", "Waste & Landfills", "Trash2", "/$slug", {
          slug: "waste-landfills",
        }),
        mkSimpleItem("roads-infrastructure", "Roads & Infrastructure", "Construction", "/$slug", {
          slug: "roads-infrastructure",
        }),
        mkSimpleItem("erosion-control-app", "Erosion Control", "Mountain", "/$slug", {
          slug: "erosion-control",
        }),
        mkSimpleItem("drainage-systems", "Drainage Systems", "Waves", "/$slug", {
          slug: "drainage-systems",
        }),
        mkSimpleItem("agriculture-aquaculture", "Agriculture & Aquaculture", "Sprout", "/$slug", {
    ...
    },
    {
      ...
      items: [
        ...
        mkSimpleItem("design-support", "Design Support", "PencilRuler", "/$slug", {
          slug: "design-support",
        }),
        mkSimpleItem("logistics", "Logistics & Customs", "Ship", "/$slug", { slug: "logistics" }),
        mkSimpleItem("after-sales", "After Sales Support", "LifeBuoy", "/$slug", {
          slug: "after-sales",
        }),
      ],
    },
    {
      ...
      items: [
        ...
        mkSimpleItem("environmental-waste", "Environmental & Waste", "Trash2", "/$slug", {
          slug: "environmental-waste",
        }),
        mkSimpleItem("water-management", "Water Management", "Droplets", "/$slug", {
          slug: "water-management",
        }),
        mkSimpleItem(
          "agriculture-aquaculture-ind",
...
function mkChild(
  ...
  label: string,
  category: string,
): import("@/types/hierarchy").HierarchyChild {
  return {
    id: slug,
    slug,
    label,
