...
export const DEFAULT_CATALOGUE_PAGE_CONTENT: CataloguePageContent = {
  hero: {
    ...
    bgImage:
      "https://geosynthetics-africa.vercel.app/api/storage/media-center/Kalanga-road-geocell-slope-stabilisation-geosynthetics-africa_7a7c9eae-ca52-4fb5-901c-a5763210b3ed.webp",
  },
};
