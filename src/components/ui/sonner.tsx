    ...
    <Sonner
      ...
      toastOptions={{
        classNames: {
          ...
          title: "font-display font-extrabold uppercase tracking-wider text-xs md:text-sm text-zinc-900",
          ...
          cancelButton: "font-display font-extrabold uppercase tracking-wider text-[10px] bg-zinc-100 text-zinc-900 hover:bg-zinc-200 rounded px-3 py-1.5 transition-colors border-none cursor-pointer",
          closeButton: "group-[.toast]:bg-zinc-100 group-[.toast]:text-zinc-500 group-[.toast]:hover:bg-zinc-200 group-[.toast]:border-none transition-colors",
