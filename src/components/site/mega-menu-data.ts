  ...
  switch (categorySlug) {
    case "geomembranes":
      return {
        ...
        secondary: [
          { label: "HDPE Geomembranes", ...productLink("hdpe-geomembranes") },
          { label: "LLDPE Geomembranes", ...productLink("lldpe-geomembranes") },
          { label: "PVC Geomembranes", ...productLink("pvc-geomembranes") },
          { label: "EPDM Geomembranes", ...productLink("epdm-geomembranes") },
          { label: "PP Geomembranes", ...productLink("pp-geomembranes") },
          { label: "Textured Geomembranes", ...productLink("textured-geomembranes") },
          { label: "Speciality Geomembranes", ...productLink("speciality-geomembranes") },
          { label: "Floating Cover Geomembranes", ...productLink("floating-cover-geomembranes") },
