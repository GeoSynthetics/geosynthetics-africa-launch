...
export const SEED_CATEGORIES: Record<string, ProductPageContent> = {
  "hdpe-geomembranes": {
    ...
    subtitle:
      "Engineered materials for critical infrastructure. Learn how our HDPE geomembranes deliver uncompromised performance, reliability, and longevity across global applications.",
    description: [
    ...
    types: [
      {
        name: "Smooth Geomembranes",
        description: "Standard high-performance barrier for general containment",
      },
      {
        name: "Textured Geomembranes",
        description: "Single or double-sided textured for increased friction on slopes",
      },
      {
        name: "White Geomembranes",
        description: "UV reflective top layer to lower liner temperature",
      },
      {
        name: "Conductive Geomembranes",
        description: "Spark-testable geomembrane for post-installation leak detection",
      },
    ],
    benefits: [
      {
        ...
        description:
          "Engineered to withstand harsh environmental conditions and mechanical stress.",
      },
      {
        title: "Chemical Resistance",
        description:
          "Highly resistant to a wide range of chemicals, making it ideal for hazardous waste.",
      },
      {
        title: "UV Protection",
        description: "Formulated with carbon black and antioxidants for superior UV resistance.",
      },
      {
        title: "Cost-Effective",
        description: "Long lifespan and low maintenance requirements provide excellent ROI.",
      },
    ],
    faqs: [
      {
        question: "What is the typical lifespan of GSE HD HDPE?",
        answer:
          "When properly installed and maintained, GSE HD HDPE geomembranes can last for decades. In exposed applications, they typically last 20-30 years, and when covered, they can exceed 100 years depending on environmental factors.",
      },
      {
        question: "Can it be installed in cold weather?",
        answer:
          "Yes, but installation in extremely cold temperatures requires special care and pre-heating of the liner to ensure proper seaming.",
      },
      {
        question: "How do you test the seams?",
        answer:
          "Seams are tested non-destructively using air pressure (for double track seams) or vacuum box testing (for extrusion welds), and destructively by peeling and shearing samples.",
      },
    ],
    installationSpecs: [
    ...
    popularProducts: [
      {
        name: "GSE HDPE Smooth",
        spec: "1.0mm – 3.0mm",
        desc: "Standard high-performance barrier for general containment",
        image: DEFAULT_IMAGES["geomembranes"],
        slug: "gse-hdpe-smooth",
      },
      {
        name: "GSE HDPE Textured",
        spec: "1.0mm – 3.0mm",
        desc: "Single-sided textured for increased friction on slopes",
        image: DEFAULT_IMAGES["geomembranes"],
        slug: "gse-hdpe-textured",
      },
      {
        name: "GSE HDPE Double Textured",
        spec: "1.0mm – 3.0mm",
        desc: "Double-sided textured for maximum stability in steep applications",
        image: DEFAULT_IMAGES["geomembranes"],
        slug: "gse-hdpe-double-textured",
      },
      {
        name: "GSE Conductive",
        spec: "1.5mm – 2.5mm",
        desc: "Spark-testable geomembrane for post-installation leak detection",
        image: DEFAULT_IMAGES["geomembranes"],
        slug: "gse-conductive",
      },
    ],
  ...
  "lldpe-geomembranes": {
    ...
    heroImage: DEFAULT_IMAGES["geomembranes"],
    subtitle:
      "Engineered materials for critical infrastructure. Learn how our LLDPE geomembranes deliver exceptional flexibility and performance.",
    description: [
    ...
    popularProducts: [
      {
        name: "GSE LLDPE Smooth",
        spec: "1.0mm – 2.0mm",
        desc: "Flexible barrier for covers and differential settlement",
        image: DEFAULT_IMAGES["geomembranes"],
      },
      {
        name: "GSE LLDPE Textured",
        spec: "1.0mm – 2.0mm",
        desc: "Textured surface for enhanced friction on slopes",
        image: DEFAULT_IMAGES["geomembranes"],
      },
      {
        name: "GSE LLDPE White",
        spec: "1.0mm – 2.0mm",
        desc: "White surface to reflect heat and lower liner temperature",
        image: DEFAULT_IMAGES["geomembranes"],
      },
      {
        name: "GSE LLDPE Reinforced",
        spec: "Custom",
        desc: "Scrim-reinforced for added dimensional stability",
        image: DEFAULT_IMAGES["geomembranes"],
      },
    ],
    applications: [
  ...
  "pvc-geomembranes": {
    ...
    heroImage: DEFAULT_IMAGES["geomembranes"],
    subtitle:
      "Highly flexible Polyvinyl Chloride (PVC) lining systems designed for easy installation and excellent conforming capabilities.",
    description: [
    ...
    popularProducts: [
      {
        name: "Standard PVC Geomembrane",
        spec: "0.5mm – 2.0mm",
        desc: "General purpose flexible liner",
        image: DEFAULT_IMAGES["geomembranes"],
      },
      {
        name: "UV Stabilised PVC",
        spec: "1.0mm – 2.0mm",
        desc: "Enhanced UV protection for exposed applications",
        image: DEFAULT_IMAGES["geomembranes"],
      },
      {
        name: "Fish-Safe PVC",
        spec: "0.5mm – 1.0mm",
        desc: "Non-toxic formulation for aquaculture and koi ponds",
        image: DEFAULT_IMAGES["geomembranes"],
      },
      {
        name: "Tunnel Waterproofing PVC",
        spec: "1.5mm – 3.0mm",
        desc: "Heavy-duty liner for underground structures",
        image: DEFAULT_IMAGES["geomembranes"],
      },
    ],
    applications: [
  ...
  "epdm-geomembranes": {
    ...
    heroImage: DEFAULT_IMAGES["geomembranes"],
    subtitle:
      "Premium Ethylene Propylene Diene Monomer (EPDM) synthetic rubber liners with unmatched elasticity, longevity, and weather resistance.",
    description: [
    ...
    popularProducts: [
      {
        name: "Standard EPDM Liner",
        spec: "1.0mm – 1.5mm",
        desc: "Premium rubber liner for ponds and reservoirs",
        image: DEFAULT_IMAGES["geomembranes"],
      },
      {
        name: "Reinforced EPDM",
        spec: "1.14mm – 1.52mm",
        desc: "Scrim-reinforced for enhanced tear resistance",
        image: DEFAULT_IMAGES["geomembranes"],
      },
      {
        name: "Potable Water EPDM",
        spec: "1.0mm",
        desc: "Certified safe for human drinking water applications",
        image: DEFAULT_IMAGES["geomembranes"],
      },
      {
        name: "EPDM Flashing Tape",
        spec: "Accessories",
        desc: "Uncured EPDM for detailing and pipe penetrations",
        image: DEFAULT_IMAGES["geomembranes"],
      },
    ],
    applications: [
  ...
  "pp-geomembranes": {
    ...
    heroImage: DEFAULT_IMAGES["geomembranes"],
    subtitle:
      "Flexible Polypropylene (fPP) geomembranes offering an excellent balance of flexibility, weldability, and chemical resistance.",
    description: [
    ...
    popularProducts: [
      {
        name: "Smooth fPP Geomembrane",
        spec: "1.0mm – 2.0mm",
        desc: "Unreinforced flexible polypropylene liner",
        image: DEFAULT_IMAGES["geomembranes"],
      },
      {
        name: "Reinforced fPP (fPP-R)",
        spec: "1.14mm – 1.52mm",
        desc: "Scrim-reinforced for high tensile strength",
        image: DEFAULT_IMAGES["geomembranes"],
      },
      {
        name: "Potable Water fPP",
        spec: "1.0mm – 1.5mm",
        desc: "Certified safe for drinking water containment",
        image: DEFAULT_IMAGES["geomembranes"],
      },
      {
        name: "Textured fPP",
        spec: "1.0mm – 2.0mm",
        desc: "Textured surface for increased slope stability",
        image: DEFAULT_IMAGES["geomembranes"],
      },
    ],
    applications: [
  ...
  "textured-geomembranes": {
    ...
    heroImage: DEFAULT_IMAGES["geomembranes"],
    subtitle:
      "Engineered geomembranes with textured surfaces designed to dramatically increase interface friction and stability on steep slopes.",
    description: [
    ...
    popularProducts: [
      {
        name: "GSE HDPE Double Textured",
        spec: "1.5mm – 2.5mm",
        desc: "Maximum friction on both sides for steep slopes",
        image: DEFAULT_IMAGES["geomembranes"],
      },
      {
        name: "GSE HDPE Single Textured",
        spec: "1.5mm – 2.5mm",
        desc: "Textured top, smooth bottom for specific designs",
        image: DEFAULT_IMAGES["geomembranes"],
      },
      {
        name: "GSE LLDPE Textured",
        spec: "1.0mm – 2.0mm",
        desc: "Combining flexibility with high friction",
        image: DEFAULT_IMAGES["geomembranes"],
      },
      {
        name: "Structured Profile Liner",
        spec: "1.5mm – 2.5mm",
        desc: "Engineered studded profile for integrated drainage",
        image: DEFAULT_IMAGES["geomembranes"],
      },
    ],
    applications: [
  ...
  "speciality-geomembranes": {
    ...
    heroImage: DEFAULT_IMAGES["geomembranes"],
    subtitle:
      "Advanced, highly engineered liner systems tailored for extreme chemical environments, high temperatures, and specific technical requirements.",
    description: [
    ...
    popularProducts: [
      {
        name: "GSE Conductive Liner",
        spec: "1.5mm – 2.5mm",
        desc: "Electrically conductive bottom layer for leak testing",
        image: DEFAULT_IMAGES["geomembranes"],
      },
      {
        name: "High-Temperature Liner",
        spec: "1.5mm – 2.0mm",
        desc: "Formulated for continuous exposure to hot fluids",
        image: DEFAULT_IMAGES["geomembranes"],
      },
      {
        name: "White Surfaced Geomembrane",
        spec: "1.5mm – 2.0mm",
        desc: "UV reflective top layer to lower liner temperature",
        image: DEFAULT_IMAGES["geomembranes"],
      },
      {
        name: "Chemical Resistant Alloy (CRA)",
        spec: "1.0mm – 2.0mm",
        desc: "Extreme resistance to highly aggressive chemicals",
        image: DEFAULT_IMAGES["geomembranes"],
      },
    ],
    applications: [
  ...
  "floating-cover-geomembranes": {
    ...
    heroImage: DEFAULT_IMAGES["geomembranes"],
    subtitle:
      "Engineered floating cover systems designed to protect water quality, prevent evaporation, and capture biogas in reservoirs and process ponds.",
    description: [
    ...
    popularProducts: [
      {
        name: "Potable Water Floating Cover",
        spec: "CSPE / fPP",
        desc: "Certified systems for drinking water reservoirs",
        image: DEFAULT_IMAGES["geomembranes"],
      },
      {
        name: "Biogas Collection Cover",
        spec: "HDPE / LLDPE",
        desc: "Gas-tight covers for anaerobic digesters",
        image: DEFAULT_IMAGES["geomembranes"],
      },
      {
        name: "Evaporation Control Cover",
        spec: "LLDPE",
        desc: "Cost-effective solution to eliminate water loss",
        image: DEFAULT_IMAGES["geomembranes"],
      },
      {
        name: "Modular Floating Hexagons",
        spec: "HDPE",
        desc: "Bird-ball alternative for modular coverage",
        image: DEFAULT_IMAGES["geomembranes"],
      },
    ],
    applications: [
...
function generateParentCategoryFallback(slug: string): ProductPageContent {
  ...
  const subtitles: Record<string, string> = {
    geomembranes:
      "Premium impermeable barrier systems engineered for extreme chemical resistance, waterproofing, and secure fluid containment in African projects.",
    geotextiles:
      "High-durability non-woven, woven, and high-strength filtration fabrics designed to optimize drainage, separation, soil reinforcement, and protection.",
    geogrids:
      "High-tensile stabilization and soil reinforcement grids engineered to increase structural bearing capacity for roads, pavements, and retaining walls.",
    geocells:
      "Three-dimensional honeycomb confinement systems engineered for slope erosion protection, channel stabilization, and heavy-duty load support.",
  ...
  const defaultTypes: Record<string, { name: string; description: string }[]> = {
    geomembranes: [
      {
        name: "HDPE Geomembranes",
        description:
          "Standard best-in-class barrier for high durability, chemical, and UV resistance.",
      },
      {
        name: "LLDPE Geomembranes",
        description:
          "Highly flexible linear low-density membranes for differential settlement and covers.",
      },
      {
        name: "PVC Geomembranes",
        description:
          "Conformable, puncture-resistant synthetic rubber-like liners ideal for tunnels and ponds.",
      },
      {
        name: "EPDM Geomembranes",
        description:
          "Premium elastomeric rubber liners with unmatched elasticity, weather, and ozone resistance.",
      },
    ],
    geotextiles: [
      {
        name: "Non-Woven Geotextiles",
        description:
          "Needle-punched PET or PP fabrics optimized for filtration, drainage, and liner protection.",
      },
      {
        name: "Woven Geotextiles",
        description:
          "High-modulus slit-film or monofilament fabrics designed for soil separation and subgrade stabilization.",
      },
      {
        name: "High-Strength Geotextiles",
        description:
          "Polyester woven fabrics with extreme tensile capacity up to 1000 kN/m for soil reinforcement.",
      },
      {
        name: "Geotextile Tubes",
        description:
          "Large permeable geo-bags used for industrial sludge dewatering and shoreline erosion protection.",
      },
    ],
    geogrids: [
      {
        name: "Biaxial Geogrids",
        description:
          "PP geogrids with square apertures designed to stabilize roads and load-bearing aggregate bases.",
      },
      {
        name: "Uniaxial Geogrids",
        description:
          "HDPE grids designed with elongated apertures to reinforce retaining walls and steep soil slopes.",
      },
      {
        name: "Triaxial Geogrids",
        description:
          "Advanced triangular structure delivering multi-directional load distribution for maximum stability.",
      },
      {
        name: "Fiberglass Geogrids",
        description:
          "High-temperature resistant grids coated with elastomeric polymer for asphalt overlay reinforcement.",
      },
    ],
    geocells: [
      {
        name: "Standard Geocells",
        description:
          "Welded cellular structures for standard retaining wall and soil confinement tasks.",
      },
      {
        name: "Textured & Perforated Geocells",
        description:
          "Roughened walls and holes for enhanced soil friction and optimal lateral water drainage.",
      },
      {
        name: "Slope Protection Geocells",
        description:
          "UV-stabilized cellular arrays designed to establish stable vegetative green slopes.",
      },
    ],
    gcls: [
      {
        name: "Standard Needle-Punched GCL",
        description: "Needle-locked sodium bentonite between non-woven and woven geotextiles.",
      },
      {
        name: "PE Coated GCL",
        description:
          "Composite GCL laminated with a thin polyethylene membrane for enhanced low-permeability safety.",
      },
      {
        name: "Reinforced GCL",
        description:
          "High-shear strength composite specifically engineered for steep slope applications.",
      },
    ],
    "drainage-composites": [
      {
        name: "Geonets",
        description:
          "High-density polyethylene bi-planar or tri-planar nets for heavy-duty gas or water venting.",
      },
      {
        name: "Geocomposite Drains",
        description:
          "Cores wrapped in protective geotextile filter fabrics to provide clean, high-flow water paths.",
      },
      {
        name: "Dimple Boards",
        description:
          "Studded plastic sheets designed for waterproofing and drainage behind structural concrete walls.",
      },
    ],
    "erosion-control": [
      {
        name: "Erosion Control Blankets (ECBs)",
        description:
          "Biodegradable natural mats (coconut coir or straw) for temporary soil protection during seeding.",
      },
      {
        name: "Turf Reinforcement Mats (TRMs)",
        description:
          "Permanent, high-strength 3D synthetic mats that reinforce root structures against severe flows.",
      },
      {
        name: "Coir Logs",
        description:
    ...
    accessories: [
      {
        name: "Solmax Welding Rods",
        description:
          "High-purity HDPE/LLDPE resin rods for continuous hot-air extrusion panel welding.",
      },
      {
        name: "Bentonite Paste & Powder",
        description:
          "Water-swellable sodium bentonite sealants for structural penetrations and detailing.",
      },
      {
  ...
  const defaultPopular: Record<
    string,
    { name: string; spec: string; desc: string; image?: string; slug?: string }[]
  > = {
    geomembranes: [
      {
        name: "GSE HDPE Smooth",
        spec: "1.0mm - 3.0mm thickness",
        desc: "Global gold-standard for lining mining pads and landfills.",
        image: heroImage,
      },
      {
        name: "GSE HDPE Textured",
        spec: "1.0mm - 2.5mm thickness",
        desc: "Single/double textured for extreme interface friction on slopes.",
        image: heroImage,
      },
      {
        name: "GSE EPDM Synthetic Rubber",
        spec: "1.0mm - 1.5mm thickness",
        desc: "Exceptional flexibility and durability for drinking water ponds.",
        image: heroImage,
      },
    ],
    geotextiles: [
      {
        name: "Needle-Punched Non-Woven PET",
        spec: "100g - 1200g/m² weight",
        desc: "Highly permeable cushion protector and filtration fabric.",
        image: heroImage,
      },
      {
        name: "High-Strength Woven Polyester",
        spec: "Up to 1000kN strength",
        desc: "Extreme tensile stabilization for embankment reinforcements.",
        image: heroImage,
      },
      {
        name: "Geotextile Sand Container",
        spec: "Custom sizing",
        desc: "Heavy-duty geotextile bag for beach and river bank protection.",
        image: heroImage,
      },
    ],
    geogrids: [
      {
        name: "Biaxial PP Geogrid",
        spec: "20/20 to 40/40 kN strength",
        desc: "Standard grid for load-bearing road base reinforcement.",
        image: heroImage,
      },
      {
        name: "Uniaxial HDPE Geogrid",
        spec: "50 to 200 kN strength",
        desc: "Engineered specifically for steep walls and bridge abutments.",
        image: heroImage,
      },
      {
        name: "Tensar TriAxial Geogrid",
        spec: "High structural stiffness",
        desc: "Triangular apertures providing maximum multi-directional load distribution.",
        image: heroImage,
      },
    ],
    geocells: [
      {
        name: "Textured & Perforated Geocell",
        spec: "75mm - 200mm depth",
        desc: "Confinement honeycomb with drainage holes and textured walls.",
        image: heroImage,
      },
      {
        name: "Standard Slope Protection Geocell",
        spec: "UV Stabilized HDPE",
        desc: "Monolithic confinement grid to establish grass slope walls.",
        image: heroImage,
      },
    ],
    gcls: [
      {
        name: "Solmax GSE GCL",
        spec: "4.5kg - 5.5kg bentonite/m²",
        desc: "Needle-punched geosynthetic clay liner offering self-healing properties.",
        image: heroImage,
      },
      {
        name: "PE Laminated GCL",
        spec: "Laminated PE backing",
        desc: "Dual hydraulic protection combining active clay with a thin poly membrane.",
        image: heroImage,
      },
    ],
    "drainage-composites": [
      {
        name: "Tri-Planar Geocomposite Drain",
        spec: "High transmissivity",
        desc: "Tri-planar HDPE geonet with laminated non-woven filter fabrics.",
        image: heroImage,
      },
      {
        name: "Prefabricated Strip Drain",
        spec: "Fast water conveyance",
        desc: "Engineered composite for rapid subsoil trench drainage.",
        image: heroImage,
      },
    ],
    "erosion-control": [
      {
        name: "3D Synthetic Turf Reinforcement Mat",
        spec: "Permanent TRM matrix",
        desc: "High-tensile three-dimensional matrix for extreme water flows.",
        image: heroImage,
      },
      {
        name: "Biodegradable Coir Matting",
        spec: "100% natural coconut fibers",
        desc: "Robust, heavy woven blanket providing immediate surface slope cover.",
        image: heroImage,
      },
    ],
    accessories: [
      {
        ...
        spec: "4mm and 5mm diameter",
        desc: "Certified high-grade welding rod matching Solmax geomembranes.",
        image: heroImage,
      },
      {
        name: "Swellable Bentonite Waterstop Paste",
        spec: "Waterproofing sealant",
        desc: "Active swelling sealant to eliminate bypass around piping and fittings.",
        image: heroImage,
      },
    ],
  };
  ...
  return {
    ...
    subtitle:
      subtitles[slug] ||
      `Premium high-performance ${label.toLowerCase()} systems engineered for critical African civil, infrastructure, and environmental containment projects.`,
    ...
    benefits: [
      {
        title: "Pan-African Supply",
        description:
          "Rapid logistics, customs clearing, and continuous stock availability across Africa.",
      },
      {
        title: "Engineered Compliance",
        description:
          "Fully certified by ISO and international bodies to satisfy rigorous tender requirements.",
      },
      {
        title: "Technical Support",
        description:
          "Design consultation, custom bill of quantities, and certified field welding support.",
      },
    ],
    faqs: [
      {
        question: `Are these ${label.toLowerCase()} products certified?`,
        answer: `Yes, all our primary geosynthetics are manufactured to international standards (such as GRI, ASTM, and ISO) and are fully certified by Solmax/GSE and other world-class bodies.`,
      },
      {
        question: "Do you supply and ship across Africa?",
        answer:
          "Absolutely. We provide complete freight logistics, customs clearance, and material delivery directly to remote mine sites and municipal locations across the African continent.",
      },
      {
        question: "Can your team assist with engineering designs?",
        answer:
          "Yes, our in-house technical department provides professional design support, value engineering, material selection advice, and detailed BOQ estimations.",
      },
    ],
    installationSpecs: [
      ...
      if (hierarchy.items && Array.isArray(hierarchy.items)) {
        ...
        if (matchedItem) {
          ...
          return {
            ...
            description:
              custom.description && custom.description.length > 0
                ? custom.description
                : fallback.description,
            features:
              custom.features && custom.features.length > 0 ? custom.features : fallback.features,
