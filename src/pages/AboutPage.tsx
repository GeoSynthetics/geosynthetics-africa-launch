        ...
        <div className="container-page py-16 md:py-24">
          <div className="max-w-3xl">
            ...
            <p className="mt-4 text-lg text-muted-foreground leading-relaxed">
              We exist to eliminate the failure risk created by fragmented delivery models, where
              material supply, logistics, installation, and quality assurance are separated. We
              integrate the full geosynthetics lifecycle.
            </p>
          </div>
          ...
          <div className="mt-16 grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="rounded border border-border bg-card p-8 hover:border-primary transition group">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                Geosynthetics Africa controls the integrity of every system from the first input -
                the material itself. We do not offer alternatives or substitutions. Every product
                supplied is fully aligned to engineer specifications, manufactured to international
                standards (GRI, ASTM), and traceable to source.
              </p>
            </div>
            ...
            <div className="rounded border border-border bg-card p-8 hover:border-primary transition group">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                ...
                equipment, and installation teams arrive aligned and on schedule. We operate across
                complex African environments, including remote mining operations and cross-border
                logistics. We don't just deliver materials - we deliver execution readiness.
              </p>
            </div>
            ...
            <div className="rounded border border-border bg-card p-8 hover:border-primary transition group">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                Installation is where most geosynthetic systems fail - not because of materials, but
                because of execution. We eliminate this risk through controlled installation
                governed by qualified teams, defined welding procedures, continuous quality control,
                and independent testing. We don't install to complete scope - we install to certify
                performance.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-10">
            <div>
              ...
              <p className="mt-3 text-base text-surface-dark-foreground/80 leading-relaxed">
                Operating across the African continent – with proven delivery in Southern, West,
                East and Central Africa – including remote mining operations and cross-border
            ...
            <div>
              ...
              <p className="mt-3 text-base text-surface-dark-foreground/80 leading-relaxed">
                Geosynthetics Africa is one of only five IAGI Installer Members in Africa, trusted
                by engineers, EPC contractors and asset owners to deliver systems exactly as
                designed – from specification through to installation sign-off.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="mt-3 text-base text-surface-dark-foreground/80 leading-relaxed">
                One system and accountable. 100+ proven tracks on QA/QC certified installation
                delivered for leading mines across Africa.
              </p>
            </div>
          </div>
          <div className="relative rounded overflow-hidden aspect-video lg:aspect-square">
            ...
            <div className="absolute bottom-0 left-0 p-8">
              ...
              <p className="text-sm text-white/80 font-semibold uppercase tracking-widest">
                We do not participate in fragmented delivery.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container-page py-16 md:py-24">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="mt-4 text-muted-foreground">
              We are proud to have partnered with globally renowned providers of sustainable and
              innovative geosynthetics. Our 10+ global partnerships across different product ranges
              allows us to meet specifications, offer quick delivery turnaround across Africa, and
              supply exact specs rather than alternatives on projects.
            </p>
          </div>
        ...
        <div className="container-page grid md:grid-cols-2 gap-8 items-center">
          ...
          <div>
            <p className="text-xs text-muted-foreground leading-relaxed">
              ...
              Mirafi® and GSE® are registered trademarks of Solmax. Tensar® is a registered
              trademark of Tensar International Corporation, a division of CMC. Eurobent® is a
              registered trademark of Eurobent Sp. z o.o. Geosynthetics Africa (Pty) Ltd supplies
              these products under authorization and does not claim ownership of any of the above
              trademarks.
            </p>
          </div>
        </div>
