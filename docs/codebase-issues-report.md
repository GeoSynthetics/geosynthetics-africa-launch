...
- **[\_\_root.tsx](file:///c:/Users/pc/dev/work-dev/geosynthetics-africa-launch/src/routes/__root.tsx#L1)**: `redirect` imported but never used.
...
- **`console.log`**: Only one statement exists in the entire `src/` directory.
  ...
  - _Status_: This is a fallback log message. It can be kept or downgraded to `console.info` or removed if it is too chatty.
