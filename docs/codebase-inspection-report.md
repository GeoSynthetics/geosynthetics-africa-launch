...
* **[__root.tsx](file:///c:/Users/pc/dev/work-dev/geosynthetics-africa-launch/src/routes/__root.tsx#L1)**:
...
* **[MediaCenterPage.tsx:L113](file:///c:/Users/pc/dev/work-dev/geosynthetics-africa-launch/src/pages/MediaCenterPage.tsx#L113)**:
  ...
  ```
  * *Status*: This is a fallback log message triggered when the programmatic creation of the `media-center` bucket fails. It is useful for debugging storage permissions in production. We can keep it, downgrade it to `console.info`, or remove it if desired.
